...
const About = () => {
  const stats = [
    { label: "Learning Journey", value: "1+", icon: FiAward },
    { label: "Projects Completed", value: "5+", icon: FiBookOpen },
    { label: "Skill Growing", value: "Daily", icon: FiAward },
  ];
          ...
          >
            ...
            <div className="space-y-3 md:space-y-4 text-gray-300 leading-relaxed text-base md:text-lg">
              <p>
                ...
                at Sarhad University Peshawer currently Working on{" "}
                <span className="text-cyan-400 font-semibold">Web Development</span> 
                , building strong foundations step by step. Also Learning{" "}
                <span className="text-cyan-400">Database</span>,{" "}
                <span className="text-cyan-400">.NET</span>, and{" "}
                <span className="text-cyan-400">microservices</span>.
               </p>

               <p>
                 Exploring <span className="text-cyan-400">HTML</span>, <span className="text-cyan-400">CSS</span>, 
                 <span className="text-cyan-400"> JavaScript</span>, and modern technologies like 
                 <span className="text-cyan-400"> React</span> and <span className="text-cyan-400"> Next.js</span>.
                </p>
               ...
               <p>
                ...
                improving daily, {" "}
                <span className="text-cyan-400">solving problems</span>, and{" "}
                <span className="text-cyan-400">moving towards freelancing</span>, and{" "}
                <span className="text-cyan-400">and real-world projects.</span>.
              </p>

              <p className="text-cyan-400 font-bold text-lg md:text-xl pt-2">
                🎯 Goal: Full Stack Developer + AI Integration + Product Development 
