...
const Certifications = () => {
  const certifications = [
    ...
    },
    {
      ...
      issuer: 'Coursera, IBM',
      icon: SiCoursera,
      file: '/Certificate of Data Visualization with Python.pdf',
      category: 'Programming',
      color: 'green',
      date: '19 May 2025',
    },
    {
      ...
      issuer: 'HackerRank',
      icon: SiCoursera,
      file: '/certificate of Foundations Data, Data, Everywhere.pdf',
      category: 'Data Science',
      color: 'orange',
      date: '05 April 2025',
    },
    {
      ...
      issuer: 'Coursera, University of London',
      icon: SiCoursera,
      file: '/certificate of Problems, Algorithms and Flowcharts.pdf',
      category: 'Data Science',
      color: 'purple',
      date: '06 April 2025',
    },
    {
      ...
      issuer: 'Coursera, Google',
      icon: SiCoursera,
      file: '/certificate of Share Data Through the Art of Visualization.pdf',
    ...
    },
    {
      ...
      issuer: 'coursera, IBM, University of London',
      icon: SiCoursera,
      file: '/Data Science Foundations.pdf',
      category: 'Data Science',
      color: 'green',
      date: '20 April 2025',
    },
  ...
  const workshops = [
    {
      ...
      issuer: 'Workshop, Sarhad University Peshawar',
      icon: FiAward,
      file: '/Coding Workshop.pdf',
      category: 'Programming',
      color: 'red',
      date: '2025',
    },
