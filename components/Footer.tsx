...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: FiPhone, href: 'tel:+923333823012', label: 'Phone' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="mt-4 space-y-1">
              <p className="text-gray-400 text-sm">mi.ismail000@gmail.com</p>
              <p className="text-gray-400 text-sm">+92-333-3823-012</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-500 text-sm">
            © {currentYear} Muhammad ismail. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
